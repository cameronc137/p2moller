#ifndef __qsimMAGNETICFIELD_HH
#define __qsimMAGNETICFIELD_HH
...
class qsimMagneticField : public G4MagneticField {
    /*! 
    ...
    public:
	qsimMagneticField( G4String );
	virtual ~qsimMagneticField();
